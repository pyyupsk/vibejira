...
- **Features Implemented (Mock):**
  ...
  - **Filter Buttons:** Placeholder CoreUI buttons (My Open Issues, etc.) - _Not functional_.
  ...
  - **Comment Sidebar:** Clicking a table row opens a CoreUI `COffcanvas`.
    ...
    - Shows action buttons (Add Comment, Add Label, Refresh) with icons - _Not functional_.
